...
console.log(`Original Lion Profile: ${JSON.stringify(lionProfile)}`);
console.log(`Lion Genetic Profile: ${JSON.stringify(lionGeneticProfile)}`);
/*
 * Observations:
...
console.log("Original Ecosystem Health:", JSON.stringify(ecosystemHealth));
console.log("Updated Ecosystem Health:", JSON.stringify(updatedEcosystemHealth));
/*
 * Observations:
